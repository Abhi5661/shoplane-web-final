...
const clothingCards = document.getElementById("clothingContainer");
const accessoriesCards = document.getElementById("accessoriesContainer");

function cardCreate(products) {
  let card = document.createElement("div");
  card.classList.add("card");
  if (products.isAccessory == false) {
    clothingCards.append(card);
  } else {
    accessoriesCards.append(card);
  }

  let previewImg = document.createElement("img");
  previewImg.src = products.preview;
  ...
  brandName.innerHTML = products.brand;
